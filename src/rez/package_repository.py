...
class PackageRepository(Generic[VariantResourceHelperT, PackageResourceHelperT, PackageFamilyResourceT]):
    ...
    def install_variant(self,
                        ...
                        dry_run: bool = False,
                        overrides: dict[str, Any] | None = None) -> VariantResourceHelperT | None:
    ...
    def get_equivalent_variant(self, variant_resource: VariantResourceHelper) -> VariantResourceHelperT | None:
