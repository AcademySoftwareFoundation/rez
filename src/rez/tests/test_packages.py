...
ALL_PACKAGES = set([
    ...
    'variant_ordered_alphabetically_same_version-1', 'eek-1.0.1', 'bar-4.8.5',
    'variant_ordered_alphabetically_reversed_same_version-1',
    'variant_ordered_alphabetically_diff_version-1',
    'variant_ordered_alphabetically_reversed_diff_version-1',
