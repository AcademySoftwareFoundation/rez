...
class TestSolver(TestBase):
    ...
    def test_14_reversed_list(self):
        """Test setting a package to reversed-version sorting
        """
        config.override("package_orderers",
                        [{"type": "sorted",
    ...
    def test_15_reversed_is_requirement(self):
    ...
    def test_16_reversed_has_requirement(self):
    ...
    def test_18_timestamp_no_rank_inexact_timestamp(self):
        config.override("package_orderers",
                        [{"type": "soft_timestamp",
                          "packages": ["reorderable"],
    ...
    def test_21_timestamp_rank3_exact_timestamp(self):
        config.override("package_orderers",
                        [{"type": "soft_timestamp",
                          "packages": ["reorderable"],
                          "timestamp": 1470728474,
    ...
    def test_25_direct_complete(self):
    ...
    def test_26_direct_single(self):
    ...
    def test_29_requirement_1_deep(self):
    ...
    def test_30_requirement_2_deep(self):
        ...
        config.override("package_orderers",
                        [{"type": "custom",
                          "packages": {"pybah": ["4"],
                                       ...
                                       "python": ["2.6.0"]}}])
        self._solve(["pyodd"],
                    ["python-2.6.0[]", "pybah-4[]", "pyodd-2[]", ".eek-1"])
        self._solve(["pyodd-2"],
                    ["python-2.6.0[]", "pybah-4[]", "pyodd-2[]", ".eek-1"])
        self._solve(["pyodd-1"],
                    ["python-2.5.2[]", "pyfoo-3.0.0[]", "pyodd-1[]", ".eek-3+"])

    def test_31_multiple_false(self):
    ...
    def test_33_orderer_used_for_variants(self):
